# Source Homebrew completions BEFORE oh-my-zsh
...
# Some applications break GPG's pinentry. Use this command to
# temporarily authenticate against GPG-agent
...
# Tailscale command alias
alias tailscale="/Applications/Tailscale.app/Contents/MacOS/Tailscale"

# Export pip packages
export PATH="/Users/ericswpark/Library/Python/3.10/bin:$PATH"

export NVM_DIR="$HOME/.nvm"
[ -s "$NVM_DIR/nvm.sh" ] && \. "$NVM_DIR/nvm.sh"  # This loads nvm
[ -s "$NVM_DIR/bash_completion" ] && \. "$NVM_DIR/bash_completion"  # This loads nvm bash_completion

# Created by `pipx` on 2023-06-19 09:39:18
export PATH="$PATH:/Users/ericswpark/.local/bin"
